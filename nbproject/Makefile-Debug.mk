...
./gearsd: ${OBJECTFILES}
	${MKDIR} -p .
	g++ -o ./gearsd ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/client/Client.o: client/Client.cpp 
	${MKDIR} -p ${OBJECTDIR}/client
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iprecomp -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/client/Client.o client/Client.cpp

${OBJECTDIR}/client/Conf.o: client/Conf.cpp 
	${MKDIR} -p ${OBJECTDIR}/client
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iprecomp -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/client/Conf.o client/Conf.cpp

${OBJECTDIR}/client/Detect_linux.o: client/Detect_linux.cpp 
	${MKDIR} -p ${OBJECTDIR}/client
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iprecomp -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/client/Detect_linux.o client/Detect_linux.cpp

${OBJECTDIR}/utils/EzCurl.o: utils/EzCurl.cpp 
	${MKDIR} -p ${OBJECTDIR}/utils
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iprecomp -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/EzCurl.o utils/EzCurl.cpp

${OBJECTDIR}/utils/json11/json11.o: utils/json11/json11.cpp 
	${MKDIR} -p ${OBJECTDIR}/utils/json11
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iprecomp -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/json11/json11.o utils/json11/json11.cpp
